<template>
    <div class="modal" id="addFormModal" tabindex="-1" role="dialog" aria-labelledby="addFormModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addFormModalLabel">Info detail</h5>
                ...
                <form method="POST" @submit.prevent="create">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="textarea" class="form-control" id="inputAddress" placeholder="Public Key"  v-model="publicKey" name='public_key'></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <span class="text-success" v-if="cameraSaved">Successfully Saved!</span>
...
export default {
    ...
    methods: {
		...mapActions(["addCamera", "clearAddCameraModal"]),
        create() {
            this.addCamera({
        ...
        closeModal() {
            ...
            this.url = ''
            this.publicKey = ''
            this.clearAddCameraModal()
        }
    },
    computed: {
        ...mapState({
            error: state => state.add.error,
            cameraSaved: state => state.add.cameraSaved
        }),
    }
}
</script>
